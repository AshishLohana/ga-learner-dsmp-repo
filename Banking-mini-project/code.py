...
if p_value > 0.05:
    ...
    inference = "Reject"
print("There is no difference in interest rate being given to people with purpose as 'small_business':", inference)
...
if p_value > 0.05:
    ...
    inference = "Reject"
print("There is no difference in installments being paid by loan defaulters and loan non defaulters:   ", inference)
