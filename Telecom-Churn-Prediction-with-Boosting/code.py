...
# Code starts here
print("Looking at label encoding for X Train: " ,X_train.head())
print("Looking at label encoding for X_test: " ,X_test.head())
print("Looking at label encoding for y_train: " ,y_train)
print("Looking at label encoding for y_test: " ,y_test)
...
print("XGBoost confusion_matrix: ",xgb_cm)
print("XGBoost classification_report: ",xgb_cr)
...
print("New Accuracy: ",clf_score)
print("New Confusion Matrix",clf_cm)
print("New Classification Report",clf_cr)
